...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--onnx",default="/home/wyw/yolov8l.onnx", help="The input ONNX model file to load")
    parser.add_argument("-e", "--engine",default="yolov8l.trt", help="The output path for the TRT engine")
